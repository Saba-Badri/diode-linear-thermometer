...
* **Amplifier Stage:** Inverting Op-Amp configuration ($\text{LM741}$) with closed-loop gain $A_v = -50$ ($R_1 = 100\,\text{k}\Omega, R_2 = 5\,\text{M}\Omega$)[cite: 3]
* **Linearity:** High linear voltage response from $-10\,\text{V}$ (at $-100^\circ\text{C}$) to $+10\,\text{V}$ (at $+100^\circ\text{C}$)[cite: 3]

---

##  Circuit Architecture & Analysis

1. **Diode Sensing Element:** Exploits $\frac{\Delta V}{\Delta T} \approx -2\,\text{mV}/^\circ\text{C}$ forward characteristic[cite: 3].
2. **Offset Cancellation Bridge:** Resistor voltage divider eliminates the baseline $607\,\text{mV}$ DC diode forward drop at $0^\circ\text{C}$, yielding $0\,\text{V}$ output at $0^\circ\text{C}$[cite: 3].
